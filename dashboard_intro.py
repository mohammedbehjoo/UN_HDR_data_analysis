...
with col1:
    st.write(
        "🇳🇴 Norway has consistently ranked as the country with the highest HDI in recent years.")
with col2:
    st.write(
        "6️⃣0️⃣ More than 60% of countries have seen an improvement in HDI since 1990.")
with col3:
...
st.markdown("## :material/double_arrow: How to navigate the app")
st.markdown("""
            ### Navigate the app 🚀
            - 📌 **Introduction Page (You are here):**
                - Learn about the HDR, its purpose, and the app's structure.
            - 📊 **Exploratory Data Analysis (EDA) Page:**
                - Visualize global trends and distributions.
                - Interact with dropdown filters to view data for specific countries or regions.
...
st.markdown(
    "- **[Dash](https://dash.plotly.com/):** For exploring layout designs and enhancing interactivity.")
